package com.example.firebasestorage.screens.museum4
...
@Composable
fun Museum4Screen(navController: NavController){
...
@Composable
fun Museum4ScreenPreview(){
    Museum4Screen(rememberNavController())
}
