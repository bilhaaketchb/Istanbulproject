package com.example.firebasestorage.screens.hotel3
...
fun Hotel3Screen(navController: NavController) {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        TopAppBar(
            ...
            navigationIcon = {
                IconButton(onClick = {/* Do Something*/ navController.navigate(ROUT_CITIES3) }) {
...
fun Hotel3ScreenPreview() {
    Hotel3Screen(rememberNavController())
