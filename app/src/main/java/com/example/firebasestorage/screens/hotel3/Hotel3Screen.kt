package com.example.firebasestorage.screens.hotels3
...
@Composable
fun HotelS3creen(navController: NavController){
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
            ...
            OutlinedButton(
                onClick = {
                    navController.navigate(ROUT_MUSEUM3)
                },
                modifier = Modifier
...
@Composable
fun hotel3ScreenPreview(){
    HotelS3creen(rememberNavController())
}
