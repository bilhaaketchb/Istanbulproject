package com.example.firebasestorage.screens.cities6
...
import com.example.firebasestorage.navigation.ROUT_EXPLORE6
...
@Composable
fun Cities6Screen(navController: NavController) {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        OutlinedButton(
            onClick = {
                navController.navigate(ROUT_EXPLORE6)
            },
            modifier = Modifier
...
@Composable
fun Cities6ScreenPreview() {
    Cities6Screen(rememberNavController())
