            ...
            Row (modifier = Modifier.padding(10.dp)){
                ...
                Card() {
                    Box(
                        ...
                        Image(
                            painter = painterResource(id = R.drawable.img_87), contentDescription = "",
            ...
            Row (modifier = Modifier.padding(10.dp)){
                Card() {
                    Box(
                        ...
                        Image(
                            painter = painterResource(id = R.drawable.img_88), contentDescription = "",
                            modifier = Modifier.fillMaxSize(),
                            contentScale = ContentScale.FillBounds
                        )
                        Icon(
            ...
            Row (modifier = Modifier.padding(10.dp)){
                Card() {
                    Box(
                        ...
                        Image(
                            painter = painterResource(id = R.drawable.img_89), contentDescription = "",
                            modifier = Modifier.fillMaxSize(),
                            contentScale = ContentScale.FillBounds
                        )
                        Icon(
