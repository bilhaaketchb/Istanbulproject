package com.example.firebasestorage.screens.museum5
...
@Composable
fun Museum5Screen(navController: NavController){
...
@Composable
fun Museum5ScreenPreview(){
    Museum5Screen(rememberNavController())
}
