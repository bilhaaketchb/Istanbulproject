package com.example.firebasestorage.screens.cities3
...
@Composable
fun Cities3Screen(navController: NavController) {
...
@Composable
fun Cities3ScreenPreview() {
    Cities3Screen(rememberNavController())
