...
fun UploadScreen(navController:NavHostController) {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        TopAppBar(
            ...
            colors = TopAppBarDefaults.largeTopAppBarColors(androidx.compose.ui.graphics.Color.Cyan),
            navigationIcon = {
        ...
        Button(onClick = { launcher.launch("image/*") },
            ...
            colors = ButtonDefaults.buttonColors(androidx.compose.ui.graphics.Color.Cyan),
