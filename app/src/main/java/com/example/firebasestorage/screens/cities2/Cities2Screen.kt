package com.example.firebasestorage.screens.cities2
...
@Composable
fun Cities2Screen(navController: NavController) {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        OutlinedButton(
            onClick = {
                navController.navigate(ROUT_EXPLORE2)
            },
            modifier = Modifier
...
@Composable
fun Cities2Preview() {
    Cities2Screen(rememberNavController())
