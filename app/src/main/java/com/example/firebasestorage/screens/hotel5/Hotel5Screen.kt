package com.example.firebasestorage.screens.hotel5
...
@Composable
fun Hotel5Screen(navController: NavController) {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        TopAppBar(
            ...
            navigationIcon = {
                IconButton(onClick = {/* Do Something*/ navController.navigate(ROUT_CITIES5) }) {
        ...
        Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
            ...
            Row(modifier = Modifier.padding(10.dp)) {
                ...
                Column(modifier = Modifier.padding(start = 20.dp)) {
                    ...
                    OutlinedButton(
                        onClick = {
                            navController.navigate(ROUT_MUSEUM5)
                        },
                        modifier = Modifier
...
@Composable
fun Hotel5ScreenPreview() {
    Hotel5Screen(rememberNavController())
