package com.example.firebasestorage.screens.hotels2
...
@Composable
fun HotelS2creen(navController: NavController){
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
            ...
            Row (modifier = Modifier.padding(10.dp)){
                ...
                Card() {
                    Box(
                        ...
                        Image(
                            painter = painterResource(id = R.drawable.img_80), contentDescription = "",
            ...
            Row (modifier = Modifier.padding(10.dp)){
                Card() {
                    Box(
                        ...
                        Image(
                            painter = painterResource(id = R.drawable.img_82), contentDescription = "",
                            modifier = Modifier.fillMaxSize(),
                            contentScale = ContentScale.FillBounds
                        )
                        Icon(
            ...
            Row (modifier = Modifier.padding(10.dp)){
                Card() {
                    Box(
                        ...
                        Image(
                            painter = painterResource(id = R.drawable.img_83), contentDescription = "",
                            modifier = Modifier.fillMaxSize(),
                            contentScale = ContentScale.FillBounds
                        )
                        Icon(
            ...
            Row (modifier = Modifier.padding(10.dp)){
                Card() {
                    Box(
                        ...
                        Image(
                            painter = painterResource(id = R.drawable.img_84), contentDescription = "",
                            modifier = Modifier.fillMaxSize(),
                            contentScale = ContentScale.FillBounds
                        )
                        Icon(
            ...
            Row (modifier = Modifier.padding(10.dp)){
                Card() {
                    Box(
                        ...
                        Image(
                            painter = painterResource(id = R.drawable.img_85), contentDescription = "",
                            modifier = Modifier.fillMaxSize(),
                            contentScale = ContentScale.FillBounds
                        )
                        Icon(
            ...
            OutlinedButton(
                onClick = {
                    navController.navigate(ROUT_MUSEUM2)
                },
                modifier = Modifier
...
@Composable
fun hotel2ScreenPreview(){
    HotelS2creen(rememberNavController())
}
