package com.example.firebasestorage.screens.hotel2
...
fun Hotel2Screen(navController: NavController) {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        TopAppBar(
            ...
            navigationIcon = {
                IconButton(onClick = {/* Do Something*/ navController.navigate(ROUT_CITIES2) }) {
...
fun Hotel2ScreenPreview() {
    Hotel2Screen(rememberNavController())
