package com.example.firebasestorage.screens.museum6
...
@Composable
fun Museum6Screen(navController: NavController){
...
@Composable
fun Museum6ScreenPreview(){
    Museum6Screen(rememberNavController())
}
