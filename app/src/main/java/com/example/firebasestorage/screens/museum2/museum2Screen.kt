package com.example.firebasestorage.screens.museum2
...
@Composable
fun Museum2Screen(navController: NavController){
...
@Composable
fun Museum2ScreenPreview(){
    Museum2Screen(rememberNavController())
}
